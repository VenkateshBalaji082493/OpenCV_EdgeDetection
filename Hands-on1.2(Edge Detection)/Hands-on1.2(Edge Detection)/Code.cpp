...
int main(int argc, const char** argv)
{
	...
	Mat inputimage = imread("E:\\Venkatesh Balaji\\MS Sem2 materials\\DIVPC\\Visual studio codes\\Images\\bird.jpg", 0);
	...
	namedWindow(window1, CV_WINDOW_AUTOSIZE); //create a window with the name "Unprocessed image"
	namedWindow(window2, CV_WINDOW_AUTOSIZE); //create a window with the name "Sobel Edge Detector"
	namedWindow(window3, CV_WINDOW_AUTOSIZE); //create a window with the name "Laplace Edge Detector"
	namedWindow(window4, CV_WINDOW_AUTOSIZE); //create a window with the name "Canny Edge Detector"
